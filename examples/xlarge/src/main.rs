//! `xlarge` — 4 M agent scheduling throughput benchmark.
//!
//! Same structure as the `large` example scaled to 4 M agents.
//! Demonstrates framework headroom toward the 5 M agent target.
//!
//! Run with:
...
fn main() -> Result<()> {
    println!("=== rust_dt  xlarge benchmark ===");
